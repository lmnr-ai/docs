...
sidebarTitle: Browser Agent Observability
description: Sync browser session recordings with agent traces
---
...
In addition, Laminar instruments popular browser automation frameworks (integrations with [Puppeteer](/ship-to-production/integrations/puppeteer), [Playwright](/ship-to-production/integrations/playwright), [Stagehand](/ship-to-production/integrations/stagehand), [BrowserUse](/ship-to-production/integrations/browser-use), and [Skyvern](/ship-to-production/integrations/skyvern)) and records the browser sessions.
...
<Tip>
If you don't have a project API key, you can get one by signing up on [Laminar](https://lmnr.ai) or spinning up a [self-hosted instance](/ship-to-production/self-hosting) and getting a key from the project settings.
</Tip>
