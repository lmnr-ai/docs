...
description: Visualize tokens, cost, latency, and model performance
---
...
Custom Dashboards are built on top of our query engine and work across `traces`, `spans`, `events`, and `tags`. You can track any metric that matters to your application.

For field details and querying tips, see the [SQL Query Engine reference](/analyze-and-debug/sql-query-engine#reference). 
## How to Build Charts
