...
These commands are the operational layer for the [Debugger](/platform/debugger): you run the agent with `LMNR_DEBUG=true`, then use these to name the session and write per-trace notes.
