...
```bash
# List all datasets in the project, or inspect one by id
...
# Rename a dataset, or delete it with every datapoint in it
lmnr-cli dataset update <dataset-id> -n my-renamed-dataset
