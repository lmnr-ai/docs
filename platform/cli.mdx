...
<Note>
Looking for the `lmnr datasets` command? That is a separate CLI bundled with the `@lmnr-ai/lmnr` SDK for managing datasets in Laminar. For full documentation visit [Datasets CLI](/datasets/cli).
</Note>
