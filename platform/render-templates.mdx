...
Clicking through datapoints keeps the view, so reviewing a whole run takes seconds per row. See [Compare runs](/evaluations/comparing-runs#see-why-a-score-moved-with-a-render-template) for how this fits into a regression workflow.
