...
Make sure general Laminar observability is configured first. See the [AI SDK integration](/integrations/vercel-ai-sdk#node-js).
...
4. In Transcript or Tree view, click the checkpoint icon on a span (**Run from here**) to reuse earlier outputs.
5. Optionally override **System Prompts** in the **Run** tab.
6. Click **Run** again to get the updated, faster trace.
7. Use Transcript or Tree view, search, and the condensed timeline to navigate.
