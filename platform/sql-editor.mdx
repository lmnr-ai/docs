...
| Column | Type | Example value |
|--------|------|---------------|
| `id` | `UUID` | `"01234567-89ab-cdef-1234-426614174000"` |
...
| `trigger_id` | `UUID` | `"44444444-5555-6666-7777-888888888888"` |
| `run_id` | `UUID` | `"22222222-3333-4444-5555-666666666666"` |
| `trace_id` | `UUID` | `"01234567-1234-cdef-1234-426614174000"` |
| `status` | `String` | `"COMPLETED"` |
| `event_id` | `UUID` | `"55555555-6666-7777-8888-999999999999"` |
...
| Column | Type | Example value |
|--------|------|---------------|
| `log_id` | `UUID` | `"01234567-89ab-cdef-1234-426614174000"` |
