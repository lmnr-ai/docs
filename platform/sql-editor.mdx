---
title: SQL Editor
description: Query Laminar data with SQL to find patterns, debug issues, and build datasets.
---
...
| Table | Contains |
|-------|----------|
| `spans` | Every span from your traces—LLM calls, tool calls, custom spans |
| `traces` | Aggregated trace-level data |
| `events` | Custom events you've sent |
| `evaluation_scores` | Results from evaluation runs |
| `evaluation_datapoints` | Datapoints used in evaluations |
