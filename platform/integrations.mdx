...
<Frame caption="Slack alerts in a connected channel">
  <img src="/images/integrations/slack-alert-notification.png" alt="Slack channel showing two Laminar alerts: a Failure Detector new event with category, description, and a View Trace button, and a new cluster with event counts and a View Cluster button" style={{ width: "100%", height: "auto" }} />
</Frame>
