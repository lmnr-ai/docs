...
<Frame>
  <img src="/images/integrations/slack-agent-thread.png" alt="Slack thread where a user asks Laminar to compare cost per trace and token usage between Gemini and Deepseek traces, and the Laminar app replies with a per-trace cost breakdown, token averages, and analysis" style={{ width: "100%", height: "auto" }} />
</Frame>
