...
description: Build evaluation datasets with a FIFO queue and labeling UI
---
...
- Labeling operation in this context means writing data to the target field of a datapoint.
