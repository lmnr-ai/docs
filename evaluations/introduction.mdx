...
- **Is the LLM-as-a-judge prompt aligned with humans?** Run [human evaluators](/evaluations/human-evaluators) on the same datapoints and see where the judge disagrees.
...
<CardGroup cols={2}>
  ...
  <Card title="Human evaluators" href="/evaluations/human-evaluators" icon="user-check">
    Add manual scoring for cases where code and LLM judges aren't enough.
  </Card>
</CardGroup>
