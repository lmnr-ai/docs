...
sidebarTitle: Kernel
description: "Trace computer-using agents that drive Kernel browsers, with the browser session recording synced to the agent's steps."
---
...
[Full guide on browser-use integration](/integrations/browser-use)
