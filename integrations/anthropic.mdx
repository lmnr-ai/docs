---
title: Anthropic observability
sidebarTitle: Anthropic
description: "Trace every Anthropic API call in TypeScript and Python: prompts, token usage, cost, and latency, all readable in Laminar's transcript view."
---
...
<Tabs items={['TypeScript', 'Python']}>
  <Tab title="TypeScript">
    ...
    <Note>
    Using Anthropic inside Next.js? The [Vercel AI SDK page](/integrations/vercel-ai-sdk#nextjs-setup) covers the Next.js-specific setup (`serverExternalPackages`, `instrumentation.ts`, and `Laminar.patch` for direct SDK clients).
    </Note>
...
- Attach sessions, user IDs, metadata, and tags to Anthropic spans via the [SDK reference](/sdk/reference).
- Wrap the functions around your Anthropic calls with `observe` and mark them as [TOOL spans](/tracing/structure/span-types) so they show up in the transcript.
