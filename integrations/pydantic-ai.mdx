---
title: Pydantic AI observability
sidebarTitle: Pydantic AI
description: "Trace Pydantic AI agent runs in Python: every model turn, typed tool call, and sub-agent run, readable as a conversation in Laminar."
---
