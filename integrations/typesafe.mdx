...
<Note>
Jev is in early access: create your key in the [TypeSafe console](https://console.typesafe.ai). No account yet? Use an [OpenRouter](/integrations/openrouter) API key with `TYPESAFE_BASE_URL=https://openrouter.ai/api` instead.
</Note>
...
<img src="/images/integrations/typesafe-trace-view.png" alt="TypeSafe AI Jev trace in Laminar with typed answers on the system_one span" />
</Frame>
