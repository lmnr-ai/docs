---
title: Browser Use observability
sidebarTitle: Browser Use
description: "Trace Browser Use agents and watch the browser session recording synced to the agent's steps, LLM calls, and screenshots."
---
