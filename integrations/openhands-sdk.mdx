...
description: "Trace OpenHands SDK conversations: every agent step, LLM call, and tool call, grouped per conversation as a Laminar session."
---
...
<Step title="Install the OpenHands SDK">
...
For non-Laminar OpenTelemetry backends, you can configure the OpenHands SDK using standard OTEL environment variables:
...
## View OpenHands traces in Laminar
