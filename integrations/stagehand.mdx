---
title: Stagehand observability
sidebarTitle: Stagehand
description: "Trace Stagehand runs and watch the browser session recording synced to each act, extract, and LLM call in Laminar."
---
