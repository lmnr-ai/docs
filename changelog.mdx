...
- **Span attribute reference** - New [Span attribute reference](/tracing/structure/span-attribute-reference) page documents every Laminar-recognized OTel attribute key (span shape, trace-association, LLM telemetry, GenAI semconv) for users shipping OTLP without the Laminar SDK.
