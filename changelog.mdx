...
- **Vercel AI SDK docs refresh** — Rewrote the AI SDK integration page with Next.js and Node.js setup in one place, grouping calls via `observe`, and the non-AI-SDK client patch pattern; retired the separate Next.js integration page.
