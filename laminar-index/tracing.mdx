...
You can do this by calling `Laminar.initialize()` at the start of your application. You can also set the `LMNR_PROJECT_API_KEY` environment variable instead of passing it directly.
