...
Prefer to wire up the SDK yourself? The [Tracing docs](/tracing/introduction) walk through installation, initialization, and the available [integrations](/tracing/integrations/overview). For where to run Laminar, see [Self-hosting](/self-hosting/overview).
