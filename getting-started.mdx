...
The fastest way to get started. Pick whichever fits your workflow.

**Skills** — reviewable diff in minutes, no manual setup.
...
Browse more at [skills.sh](https://skills.sh) · Source: [lmnr-ai/laminar-skills](https://github.com/lmnr-ai/laminar-skills)

**Cursor rules** — Laminar-aware completions in your editor.
...
**Copy a prompt** — paste [this prompt](#) into ChatGPT, Claude, or any assistant alongside your codebase.

> Laminar ships fast. If AI output conflicts with these docs, follow the docs.
...
- [Instrument an existing product](#) — structured spans, context, tags, privacy
- [Basic install + auto-instrumentation](#) — minimal code, traces immediately
- [Migrate from another platform](#) — swap from Langfuse/LangSmith/Helicone/OTel
