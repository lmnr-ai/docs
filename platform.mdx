...
<CardGroup cols={2}>
  ...
  <Card title="Laminar Agent" href="/platform/laminar-agent">
    Ask about your traces, costs, and signals in plain language from MCP, the CLI, or Slack.
  </Card>
  ...
  <Card title="PII redaction" href="/platform/pii-redaction">
    Strip names, emails, and other PII from span input and output, for everyone or per reader with Dual mode.
  </Card>
  <Card title="Render templates" href="/platform/render-templates">
    Generate JSX templates that render spans and traces your way.
  </Card>
  <Card title="Custom model costs" href="/platform/custom-model-costs">
    Price fine-tuned and self-hosted models with your own per-project rates.
  </Card>
  <Card title="LLM profiles" href="/platform/llm-profiles">
    Add your own provider credentials and models for the playground and Signals.
  </Card>
  <Card title="Slack integration" href="/platform/integrations">
    Connect Slack for signal alerts, reports, and Laminar Agent.
  </Card>
</CardGroup>
