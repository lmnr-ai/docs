...
export const COPY_PROMPT_BUTTON_STYLE = {
  ...
  padding: '12px 14px',
  borderRadius: '12px',
  border: '1px solid rgba(237, 110, 64, 0.45)',
...
>
  Have an existing pipeline/product and want to incorporate Laminar?
</button>
...
<button
  ...
  style={COPY_PROMPT_BUTTON_STYLE}
>
  Just want a basic install + auto-instrumentation?
</button>
...
<button
  ...
  style={COPY_PROMPT_BUTTON_STYLE}
>
  Migrating from another observability platform?
</button>
