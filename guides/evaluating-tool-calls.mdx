...
- **[Tracing Documentation](/observe-in-production/traces-and-spans)**: Learn more about automatic instrumentation, manual span creation, and advanced tracing patterns
