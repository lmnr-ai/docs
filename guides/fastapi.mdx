...
```bash
pip install -U fastapi uvicorn openai lmnr python-dotenv
```
...
After making a request, you can view the traces in your Laminar dashboard at https://laminar.sh. The trace will show:
