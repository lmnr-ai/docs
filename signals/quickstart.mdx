...
<Note>
Creating a Signal automatically creates a **Critical**-severity signal event alert and a new-cluster alert, both posting to the in-app notification center. Open **Project Settings > Alerts** to route them to Slack or email, change the severity, or turn off *skip similar events*. See [Alerts](/signals/alerts).
</Note>
