...
<Note>
Creating a Signal automatically creates a **Critical**-severity event alert posting to the in-app notification center. Open **Project Settings > Alerts** to route them to Slack or email, change the severity, or manage notification frequency. See [Alerts](/signals/alerts).
</Note>
