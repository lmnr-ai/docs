...
<Note>
Creating a Signal also creates a **Critical**-severity event alert and subscribes your email. When clustering is available, it creates a **New cluster** alert too. Route either alert to Slack, change its settings, or add output-schema filters from the Signal's **Settings > Alerts** section. See [Alerts](/signals/alerts).
</Note>
