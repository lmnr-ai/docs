...
1. A **New event** alert on the new Signal, scoped to **Critical** severity. When clustering is available, [*skip similar events*](#skip-notifications-for-similar-events) is on by default.
2. A **New cluster** alert when clustering is available.
