...
You can also run queries directly from the API. Read the [API reference](/api-reference/sql/sql_query) page for more information.
...
- [In-depth guide](/sql-editor/guide) – In-depth guide to the Laminar SQL Editor with examples
