...
You almost certainly want to add a `start_time` filter to your query. This will speed up the query and prevent it from failing because of running out of memory.
