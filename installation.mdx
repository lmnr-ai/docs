...
<Note>
If you just want the fastest path, use the commands below. For advanced control (selective instrumentation, proxies), see [automatic instrumentation](/tracing/automatic-instrumentation).
</Note>
...
<Callout>
Embed placeholder: short GIF of running the three commands and opening the resulting trace with cost + tokens visible.
</Callout>
