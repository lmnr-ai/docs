...
- Exports rejected as too large by the ingest endpoint, so every span in that batch is lost. See [Troubleshooting](/tracing/troubleshooting) for the exact errors per transport.
