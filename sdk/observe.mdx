...
<Tabs items={['TypeScript', 'Python']}>
  <Tab title="TypeScript">
    ...
    **Behavior:**
    ...
    - In rollout sessions, Laminar attaches `rollout.session_id` from `LMNR_ROLLOUT_SESSION_ID`
    ...
    **Examples: Rollout entrypoint**
    ...
    // Start a session with: npx lmnr-cli dev path/to/entrypoint.js
    ```
  ...
  <Tab title="Python">
    ...
    **Parameters:**
    ...
    | `span_type` | `'DEFAULT'` &#124; `'LLM'` &#124; `'EXECUTOR'` &#124; `'EVALUATOR'` &#124; `'HUMAN_EVALUATOR'` &#124; `'EVALUATION'` | `'DEFAULT'` | Span type (`PIPELINE` is reserved internally) |
