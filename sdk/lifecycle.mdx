...
<Tabs items={['TypeScript', 'Python']}>
  ...
  <Tab title="Python">
    ...
    **Note:** Unlike JavaScript SDK, Python SDK cannot re-initialize after shutdown.
    ...
    - **Input/output size:** Values >10MB are truncated to the 10MB limit with a trailing `...[Laminar: truncated]` marker. The recorded value is no longer valid JSON, but the start of the payload is preserved.
