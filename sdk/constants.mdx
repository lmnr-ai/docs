...
<Tabs items={['TypeScript', 'Python']}>
  <Tab title="TypeScript">
    ...
    // SpanType:
    // 'DEFAULT' | 'LLM' | 'EXECUTOR' | 'EVALUATOR' | 'HUMAN_EVALUATOR'
    // | 'EVALUATION' | 'TOOL' | 'CACHED'
    //
  ...
  <Tab title="Python">
    ...
    # SpanType: DEFAULT, LLM, TOOL, EXECUTOR, EVALUATOR, HUMAN_EVALUATOR, EVALUATION
    #   (PIPELINE is reserved internally)
    # TraceType: DEFAULT, EVALUATION
    ```
  </Tab>
</Tabs>
