...
Chat-with-trace, SQL-with-AI, and trace clustering run through one unified LLM provider configuration. Set the provider on all three application pods (they default to `gemini`), and supply the key:
