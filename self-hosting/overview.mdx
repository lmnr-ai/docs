...
- **Helm + license**: the same chart with an [enterprise license key](mailto:founders@lmnr.ai). Adds priority support and the option to have Laminar fully manage, scale, and update your deployment in your own AWS or GCP infrastructure.
...
| Community (Discord) | ✓ | ✓ | ✓ | ✓ |
| Priority support | - | - | ✓ | ✓ |
| Fully managed in your AWS or GCP infra | - | - | ✓ | - |
...
With an enterprise license, Laminar can fully manage your deployment, including scaling and updates, inside your own AWS or GCP account under scoped access, close to a forward-deployed model. [Contact us](mailto:founders@lmnr.ai) to set this up.
</Note>
