...
sidebarTitle: Automatic Instrumentation
description: Trace supported libraries and frameworks with no code changes
---
...
<Tip>
See [Integrations](/ship-to-production/integrations/) for provider- and framework-specific setup.
</Tip>
...
- **Next.js applications**: See the [Next.js integration guide](/ship-to-production/integrations/nextjs)
- **Vercel AI SDK**: See the [Vercel AI SDK guide](/ship-to-production/integrations/vercel-ai-sdk)
- **LangChain**: See the [LangChain integration guide](/ship-to-production/integrations/langchain)
...
1. **Add structure** with [`observe` and manual spans](/ship-to-production/manual-instrumentation)
2. **Organize traces** into [sessions, users, and metadata](/observe-in-production/sessions-users-metadata)
3. **Review production behavior** in [Traces & Spans](/observe-in-production/traces-and-spans) and [Custom Dashboards](/observe-in-production/custom-dashboards)
4. **Track costs** with [Cost & Token Tracking](/observe-in-production/cost-and-token-tracking)
