...
<Tabs items={['TypeScript', 'Python']}>
  <Tab title="TypeScript">
    ...
    <Note>
    If you are using OpenAI with Next.js, please follow the [Next.js integration guide](/ship-to-production/integrations/nextjs) for best practices and setup instructions.
    </Note>
...
- [Realtime Monitoring](/build-and-experiment/real-time-traces) - See how to monitor your OpenAI calls in real-time
