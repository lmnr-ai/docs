...
sidebarTitle: Kernel
description: Instrument your computer-using agents running on Kernel with Laminar
---
...
1. A [Laminar](https://laminar.sh) account or a [self-hosted instance](/self-hosting/setup).
...
[Full guide on browser-use integration](/ship-to-production/integrations/browser-use)
...
- Understand [browser observability](/observe-in-production/browser-agent-observability) in more detail.
