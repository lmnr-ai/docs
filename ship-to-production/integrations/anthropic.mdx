...
<Tabs items={['TypeScript', 'Python']}>
  <Tab title="TypeScript">
    ...
    <Note>
    If you are using Anthropic with Next.js, please follow the [Next.js integration guide](/ship-to-production/integrations/nextjs) for best practices and setup instructions.
    </Note>
...
- [Sessions](/observe-in-production/sessions-users-metadata) - Learn how to add session structure to your traces
- [Metadata](/observe-in-production/sessions-users-metadata) - Discover how to add additional context to your LLM spans
- [Trace structure](/ship-to-production/manual-instrumentation) - Explore creating custom spans and more advanced tracing
- [Realtime Monitoring](/build-and-experiment/real-time-traces) - See how to monitor your Anthropic calls in real-time
