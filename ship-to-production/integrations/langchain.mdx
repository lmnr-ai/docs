...
- [Sessions](/observe-in-production/sessions-users-metadata) - Group related LangChain executions (e.g., a user conversation).
- [Metadata](/observe-in-production/sessions-users-metadata) - Add custom context (e.g., user IDs, environment details) to your LangChain traces.
- [Trace structure](/ship-to-production/manual-instrumentation) - Create custom spans to instrument parts of your application logic outside of LangChain.
- [Realtime Monitoring](/build-and-experiment/real-time-traces) - Observe your LangChain applications in real-time. 