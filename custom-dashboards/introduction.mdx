---
title: "Introduction to Custom Dashboards"
sidebarTitle: "Introduction"
---

Build custom dashboards to track any metrics that matter to your application - from performance and costs to usage patterns and reliability.
Each project has pre-built dashboards that track key LLM metrics for your project.
