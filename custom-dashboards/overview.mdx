...
The schema autocomplete knows which columns exist on each table. For the full list of tables (`traces`, `spans`, `signal_events`, `evaluation_results`, etc.) and their columns, see the [SQL editor table schemas reference](/platform/sql-editor#table-schemas).
