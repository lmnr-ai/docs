...
- [Anthropic](/integrations/anthropic) (Python)
- [Google GenAI](/integrations/gemini) (Python)
- [LiteLLM](/integrations/litellm) (Python)
- [AI SDK](/integrations/vercel-ai-sdk) (TypeScript, all providers): requires `wrapLanguageModel`, see [setup](/debugger/setup#ai-sdk-caching)
...
The debugger itself runs with **many more integrations than this**. Recording, inspecting the transcript, and replaying work with everything Laminar [integrates with](/integrations) and with [manual LLM instrumentation](/tracing/structure/manual-span-creation). Caching is the only part limited to the list above: with an unsupported integration, every LLM call on a replay run goes live rather than serving from the recorded trace.
