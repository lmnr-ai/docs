...
- [OpenAI](/tracing/integrations/openai) (Python, TypeScript)
- [Anthropic](/tracing/integrations/anthropic) (Python, TypeScript)
- [Google GenAI](/tracing/integrations/gemini) (Python, TypeScript)
- [LiteLLM](/tracing/integrations/litellm) (Python)
- [AI SDK](/tracing/integrations/vercel-ai-sdk) (TypeScript): requires `wrapLanguageModel`, see [setup](/debugger/setup#special-case-ai-sdk)
