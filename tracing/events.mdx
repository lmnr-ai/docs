...
## Viewing and clustering events

In the Laminar UI, open **Events** to browse and filter event streams. If you want to cluster an event definition, see [Semantic Events & Clusters](/tracing/semantic-events-clusters).

You can also query custom events in the [SQL Editor](/platform/sql-editor) using the `events` table.
