...
Use these methods to send your OpenTelemetry traces to Laminar, even if you are not using Laminar's SDK.

If you are using Laminar's SDK, refer to the [tracing quickstart](/tracing/quickstart) page to get started.
...
about tracing in Laminar, and a quick intro to the core concepts, see the [Tracing quickstart](/tracing/quickstart) page.
...
[project API key](http://localhost:3001/tracing/quickstart#three-commands-to-first-trace).
