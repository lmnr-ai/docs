...
description: "Trace OpenCode coding agent sessions: every model turn and tool call, grouped per session and readable as a conversation in Laminar."
---
...
<CardGroup cols={2}>
  <Card title="Claude Agent SDK" href="/tracing/integrations/claude-agent-sdk">
    Running OpenCode alongside the Claude Agent SDK? Trace both here.
  </Card>
  ...
  <Card title="Pi" href="/tracing/integrations/pi">
    Trace Pi coding agent sessions with a one-command extension.
  </Card>
