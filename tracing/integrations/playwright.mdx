---
title: "Playwright (JS and Python)"
---
...
Laminar has a native integration with Playwright. You simply need to initialize Laminar with your project API key and Playwright will be traced automatically.
