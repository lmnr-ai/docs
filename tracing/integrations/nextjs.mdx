---
title: "Observability for Next.js LLM Applications"
sidebarTitle: Next.js
description: "Add LLM observability to your Next.js applications. Trace OpenAI, Anthropic, and other LLM calls with OpenTelemetry-based monitoring."
---
...
<Note>
If you are using Vercel AI SDK, see the [Vercel AI SDK integration](/tracing/integrations/vercel-ai-sdk) which includes a full Next.js setup guide.

For complete example apps, see the [Next.js + AI SDK guide](/guides/nextjs-aisdk) and the [Next.js guide](/guides/nextjs).
</Note>
...
See the full setup in the [Vercel AI SDK integration guide](/tracing/integrations/vercel-ai-sdk).
