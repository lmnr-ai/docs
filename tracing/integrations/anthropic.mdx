...
<Tabs items={['TypeScript', 'Python']}>
  <Tab title="TypeScript">
    ...
    <Note>
    If you are using Anthropic with Next.js, please follow the [Vercel AI SDK integration guide](/tracing/integrations/vercel-ai-sdk) for best practices and setup instructions.
    </Note>
