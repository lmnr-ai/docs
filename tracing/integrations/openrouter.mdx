...
<Tabs items={['TypeScript', 'Python']}>
  <Tab title="TypeScript">
    ...
    <Note>
    If you are using OpenRouter with Next.js, see the [Next.js setup in the Vercel AI SDK guide](/tracing/integrations/vercel-ai-sdk) for `instrumentation.ts`, `next.config.ts`, and patching non-AI-SDK clients.
    </Note>
