...
Laminar automatically instruments the OpenAI SDK. If you set the OpenAI SDK base URL to OpenRouter, Laminar will capture those calls with full LLM trace details.
...
If you use the OpenRouter SDK directly, wrap your call with `observe()` to capture inputs/outputs and group it in a trace.
...
After instrumenting your OpenRouter calls with Laminar, you'll be able to:
