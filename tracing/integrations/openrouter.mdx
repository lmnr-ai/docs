...
<Tabs items={['TypeScript', 'Python']}>
  <Tab title="TypeScript">
    ...
    <Note>
    Using OpenRouter inside Next.js? The [Vercel AI SDK page](/tracing/integrations/vercel-ai-sdk#nextjs-setup) covers the Next.js-specific setup (`serverExternalPackages` and `instrumentation.ts`).
    </Note>
  </Tab>
  <Tab title="Python">
    ### 1. Install Laminar and the OpenRouter SDK
...
- Wrap your own functions with `observe` to capture business logic alongside model calls, and mark tools as TOOL spans so they show up in the transcript. See [Span types](/tracing/structure/span-types).
