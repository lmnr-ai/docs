...
When multiple Claude agents collaborate in a single run, Laminar renders each agent as a distinct branch in the trace so you can follow handoffs and parallel work.

Example multi-agent trace:

<img src="/images/traces/claude-agent-sdk-multi-agent.png" alt="Claude Agent SDK multi-agent trace" />
