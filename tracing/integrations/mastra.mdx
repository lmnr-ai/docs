...
sidebarTitle: Mastra
description: "Trace Mastra agents, workflows, and tools in TypeScript: model turns, tool calls, sub-agents, token usage, and cost."
---
...
<CardGroup cols={2}>
  <Card title="Vercel AI SDK" href="/tracing/integrations/vercel-ai-sdk">
    Mastra runs on the AI SDK. Calling it directly? Trace it here.
  </Card>
