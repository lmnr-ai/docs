...
- **LLM providers SDKs** (OpenAI, Anthropic, Azure OpenAI, Vertex/AI Platform, Bedrock, Cohere)
- **LLM Frameworks** (LangChain, LlamaIndex)
- **Vector database operations** (Pinecone, Qdrant, Chroma)
- **Browser automation** (Playwright, Puppeteer, Stagehand — JavaScript/TypeScript)
...
- Vertex AI / AI Platform (`@google-cloud/vertexai`, `@google-ai/generativelanguage`)
