...
<Tip> For automatic instrumentation, you can try importing **AND** initializing Laminar before importing any instrumentable modules.</Tip>
...
or [view source](https://github.com/lmnr-ai/lmnr-python/blob/main/src/lmnr/opentelemetry_lib/instruments.py).
