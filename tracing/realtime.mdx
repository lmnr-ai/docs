...
<Note>
Real-time SSE is available in both Laminar Cloud and self-hosted deployments. For self-host, ensure the `/api/v1/projects/{project_id}/realtime` route is exposed.
</Note>
