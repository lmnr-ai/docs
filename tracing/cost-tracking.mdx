...
For [auto-instrumented providers and frameworks](/integrations) this needs no configuration. Initialize the SDK and every LLM call carries token counts and cost. The rest of this page covers what Laminar prices, how it arrives at the number, and how to instrument calls it does not trace automatically.
...
Auto-instrumentation covers the providers and frameworks on the [integrations list](/integrations). Create LLM spans by hand for:
