...
<Tip>
If you don't have a project API key, you can get one by signing up on [Laminar](https://lmnr.ai) or spinning up a [self-hosted instance](/startup) and getting a key from the project settings.
</Tip>
