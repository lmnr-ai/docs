...
Learn more about advanced tracing techniques:

- **[Custom span attributes](/tracing/structure/span-attributes)** for LLM instrumentation and metadata
- **[Continuing traces](/tracing/structure/continuing-traces)** across services and functions  
- **[Provider configuration](/tracing/structure/providers)** for accurate cost tracking
- **[Advanced manual instrumentation](/tracing/manual-instrumentation)** for fine-grained control
