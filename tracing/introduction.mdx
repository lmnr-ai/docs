...
<CardGroup cols={2}>
  <Card title="Integrations" href="/integrations/overview">
    You're already using supported libraries. Find setup instructions and what's captured for each agent framework, LLM provider, and browser agent.
  </Card>
  ...
  <Card title="OpenTelemetry" href="/tracing/otel">
    You already have an OTel pipeline. Point your existing exporter at Laminar's OTLP endpoint.
  </Card>
