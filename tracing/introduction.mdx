---
title: Introduction to Tracing with Laminar
...
- Explore [Advanced Configuration](/tracing/configuration) for customizing your tracing setup
- Check out [Common Patterns](/tracing/patterns) for typical LLM application tracing strategies