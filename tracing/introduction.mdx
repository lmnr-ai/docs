...
This automatic recording is called *instrumentation*. You can also manually instrument your own functions—see [Tracing Patterns](/tracing/patterns).
...
Sessions also enable [session replay](/tracing/sessions)—you can watch a conversation unfold step by step.

---

## Next Steps

- **[Tracing Patterns](/tracing/patterns)** — Add context to traces, instrument your own functions, handle cross-service tracing
- **[SDK Reference](/sdk)** — Full API documentation
- **[Evaluations](/evaluations)** — Score and test your traces automatically
