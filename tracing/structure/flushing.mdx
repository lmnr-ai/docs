...
<Warning>
**Do not use manual flushing in high-traffic web servers.**
If you put `flush()` in every API handler of a web server, it will severely degrade performance.
</Warning>
...
failure scenario for serverless functions like AWS Lambda.
