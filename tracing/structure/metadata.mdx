...
See also: [TypeScript trace methods](/sdk/typescript/trace-methods#laminar-settracemetadata-metadata) • [Python trace methods](/sdk/python/trace-methods#laminar-set-trace-metadata-metadata)
