...
<Tabs items={['TypeScript', 'Python']}>
  <Tab title="TypeScript">
    ...
    On Vercel AI SDK v7, pass metadata per call through `runtimeContext` and opt each key in with `telemetry.includeRuntimeContext`. See [Attach metadata, sessions, user IDs, and tags](/integrations/vercel-ai-sdk#attach-metadata-sessions-user-ids-and-tags).
  </Tab>
  <Tab title="Python">
    ```python
