...
See also: [TypeScript span methods](http://localhost:3000/sdk/typescript/span-methods#laminar-setspanoutput-output) • [Python span methods](http://localhost:3000/sdk/python/span-methods#laminar-set_span_output-output)
