...
Laminar automatically calculates costs for LLM calls when the correct provider and model names are set. Use this list of supported providers and model names to ensure costs are calculated correctly.
