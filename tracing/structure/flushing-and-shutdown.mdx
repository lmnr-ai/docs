...
## Controlling when batches are sent

Flushing at exit is one half of the story; the other is how batches are formed while your process runs. Both SDKs export on a span count or a scheduled delay, and can also export on payload size for agents whose spans carry large prompts and completions. See [Batching](/sdk/batching).
