...
<img className="block" src="/images/traces/sessions.png" alt="Sessions tab showing traces grouped by session" />

Each trace within a session contains the same information as a standalone trace:

<img className="block" src="/images/traces/trace-in-session.png" alt="Trace detail view for a trace within a session" />
