...
See also: [Trace methods (TypeScript)](/sdk/trace-methods#laminar-settraceuserid-userid) • [Trace methods (Python)](/sdk/trace-methods#laminar-set_trace_user_id-user_id)
