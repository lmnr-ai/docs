...
Events are things that happened in your system that are worth recording. Each event is associated with span and correponding trace.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Cluster events to identify patterns"
    icon="layer-group"
    href="/tracing/events/clusters"
  >
