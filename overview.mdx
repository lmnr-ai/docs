...
When self-hosting, Laminar supports GitHub authentication with optional email-based access restrictions.

Learn more about [Access Control Setup](/self-hosting/access-control-setup).
