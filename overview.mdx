...
Initialize once to get full visibility into every LLM call, browser action, and agent step. Open-source. Self-hostable. Production-ready.
...
2. [Installation](/installation) — add Laminar to your stack  
3. [How Laminar works](/how-it-works) — architecture overview for production  
4. [Evaluations](/evaluations/quickstart) — score your AI once you have traces and datasets
