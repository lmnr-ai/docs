...
Laminar is open-source observability and evaluations for AI agents—self-host from [GitHub](https://github.com/lmnr-ai/lmnr) or use the cloud at [laminar.sh](https://laminar.sh).
...
<Columns>
    ...
    <Card title="SQL Query Editor" href="/platform/sql-editor">
